...
import numpy as np
import cv2
import api.mtcnn_source.pytrt as pytrt
...
class TrtMtcnn(object):
    ...
    def __init__(self, ml_models):
        self.pnet = TrtPNet(ml_models["pnet"])
        self.rnet = TrtRNet(ml_models["rnet"])
        self.onet = TrtONet(ml_models["onet"])
    ...
    def detect(self, img, minsize=20):
        """detect()
